defmodule AdventOfCode.Day02Test do
  ...
  describe "part2" do
    test "minimal bag" do
      game = [1, [%{"blue" => 3, "red" => 4}, %{"blue" => 6, "green" => 2, "red" => 1}]]

      assert minimal_bag(game) == %{
               "red" => 4,
               "blue" => 6,
               "green" => 2
             }
